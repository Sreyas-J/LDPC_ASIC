...
//        end
    ...
    always @(*) begin
                ...
                qv_list[0] = 5'h07; // e.g., strong '0' (+7)
                qv_list[1] = 5'h1A; // e.g., moderate '1' (-6)
                qv_list[2] = 5'h02; // e.g., weak '0' (+2)
                qv_list[3] = 5'h1F; // e.g., very weak '1' (-1)
                qv_list[4] = 5'h0C; // (+12)
                qv_list[5] = 5'h14; // (-12)
                qv_list[6] = 5'h00; // Complete uncertainty (0)
                qv_list[7] = 5'h0E; // (+14)
                qv_list[8] = 5'h11; // (-15)
                qv_list[9] = 5'h05; // (+5)
                qv_list[10] = 5'h18; // (-8)
