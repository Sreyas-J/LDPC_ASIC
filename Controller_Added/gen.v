...
output reg [11:0] cv_list
    ...
    //   PE0:  L0=CN2, L1=CN8, L2=bypass     bypass=3'b100
    //   PE1:  L0=CN0, L1=CN6, L2=bypass     bypass=3'b100
    //   PE2:  L0=CN1, L1=CN7, L2=bypass     bypass=3'b100
    //   PE3:  L0=CN0, L1=CN4, L2=CN6        bypass=3'b000
    //   PE4:  L0=CN1, L1=CN5, L2=CN7        bypass=3'b000
    //   PE5:  L0=CN2, L1=CN3, L2=CN8        bypass=3'b000
    //   PE6:  L0=CN3, L1=CN7, L2=bypass     bypass=3'b100
    //   PE7:  L0=CN4, L1=CN8, L2=bypass     bypass=3'b100
    //   PE8:  L0=CN5, L1=CN6, L2=bypass     bypass=3'b100
    ...
    assign bypass[0]  = 3'b100;
    assign bypass[1]  = 3'b100;
    assign bypass[2]  = 3'b100;
    assign bypass[3]  = 3'b000;
    assign bypass[4]  = 3'b000;
    assign bypass[5]  = 3'b000;
    assign bypass[6]  = 3'b100;
    assign bypass[7]  = 3'b100;
    assign bypass[8]  = 3'b100;
    ...
    //   CN3: PE5(L1), PE6(L0), PE9(L1)
    //   CN4: PE3(L1), PE7(L0), PE10(L1)
    //   CN5: PE4(L1), PE8(L0), PE11(L1)
    //   CN6: PE1(L1), PE3(L2), PE8(L1), PE10(L2)
    //   CN7: PE2(L1), PE4(L2), PE6(L1), PE11(L2)
    //   CN8: PE0(L1), PE5(L2), PE7(L1), PE9(L2)
    // ---------------------------------------------------------------
    ...
    always @(*) begin
        ...
        cn_min2 = 4'hF;
        // PE7
        cn_lvc_sign_tmp = lvc_sign[7][0]; cn_lvc_mag_tmp = lvc_mag[7][0];
        cn_sc = cn_sc ^ cn_lvc_sign_tmp;
        if (cn_lvc_mag_tmp < cn_min1) begin cn_min2 = cn_min1; cn_min1 = cn_lvc_mag_tmp; end
        else if (cn_lvc_mag_tmp < cn_min2) begin cn_min2 = cn_lvc_mag_tmp; end
        // PE10
    ...
    // 11  | CN0  | CN5  | CN7
    // ---------------------------------------------------------------
    assign mcv_t[0]  = {9'h1FF, cn_summary[8], cn_summary[2]};
    assign mcv_t[1]  = {9'h1FF, cn_summary[6], cn_summary[0]};
    assign mcv_t[2]  = {9'h1FF, cn_summary[7], cn_summary[1]};
    ...
    assign mcv_t[6]  = {9'h1FF, cn_summary[7], cn_summary[3]};
    assign mcv_t[7]  = {9'h1FF, cn_summary[8], cn_summary[4]};
    assign mcv_t[8]  = {9'h1FF, cn_summary[6], cn_summary[5]};
